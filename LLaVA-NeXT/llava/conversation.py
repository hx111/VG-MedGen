...
local_llama3_path = "/home/daocp02/neu_hx/code/medart-main/LLaVA-NeXT/lmms-labllama3-llava-next-8b"
conv_llava_llama_3 = Conversation(
    ...
    tokenizer_id=local_llama3_path,
    # tokenizer=safe_load_tokenizer("meta-llama/Meta-Llama-3-8B-Instruct"),
    tokenizer=safe_load_tokenizer(local_llama3_path),
