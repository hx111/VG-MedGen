...
from .sdnet2 import *
from .sdnet3 import *
from.sdnet_hierarchical import *
from .sdnet_hierarchical1 import *
...
def get_model(name, params):
    ...
    elif name == 'sdnet_hierarchical':
        return SDNetHierarchical(params)
    elif name == 'sdnet_hierarchical1':
        return SDNetHierarchical1(params)
    else:
