...
def save_network_state(model, width, height, ndf, norm, upsample, num_classes, anatomy_out_channels, z_length, num_mask_channels, optimizer, epoch , name , save_path):
